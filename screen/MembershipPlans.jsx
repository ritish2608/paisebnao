...
import { View, Text, Button, ScrollView, Alert, StyleSheet, Modal } from 'react-native';
                ...
                {plans.map((data, index) => (
                    <View key={index} style={styles.plan}>
                        <Text style={styles.planTitle}>
                            {data.type} <Text style={styles.note}>Withdrawal in {data.withdrawl_days} days</Text>
                        </Text>
                        ...
                        {data.deposit_point.length > 0 && (
                            <View style={styles.deposits}>
                                    ...
                                    <View key={index} style={styles.depositItem}>
                                        <Text>
                                            ► Deposit <Text style={styles.greenText}>₹{data.video_point}</Text> and get <Text style={styles.greenText}>₹{data.video_point}</Text> per video.
                                        </Text>
                                        <Button
                                            title="Deposit"
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        <Text>Are you sure you want to proceed with the payment for {selectedPlan?.type} plan of ₹{selectedDeposit?.amount}?</Text>
